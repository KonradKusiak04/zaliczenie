...
<span class="s4">void </span><span class="s1">menu</span><span class="s5">(</span><span class="s4">void</span><span class="s5">) {</span>
    <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;1. Wyswietl liczby z tablicy</span><span class="s4">\n</span><span class="s2">&quot;</span><span class="s5">);</span>
    <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;2. Wyswietl najnizszom wartosc</span><span class="s4">\n</span><span class="s2">&quot;</span><span class="s5">);</span>
    <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;3. Wyswietl najwyszom wartosc</span><span class="s4">\n</span><span class="s2">&quot;</span><span class="s5">);</span>
    <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;4. Wyswietl sredniom wartosc</span><span class="s4">\n</span><span class="s2">&quot;</span><span class="s5">);</span>
    <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;5. Zapisz wartosci tablicy do pliku</span><span class="s4">\n</span><span class="s2">&quot;</span><span class="s5">);</span>
    <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;6. Cofnij wartosci tablicy z pliku</span><span class="s4">\n</span><span class="s2">&quot;</span><span class="s5">);</span>
...
<span class="s5">}</span>
<span class="s4">int </span><span class="s1">savearraytofile</span><span class="s5">(</span><span class="s4">int </span><span class="s1">array</span><span class="s5">[]) {</span>
    <span class="s1">FILE </span><span class="s5">*</span><span class="s1">fptr </span><span class="s5">= </span><span class="s1">NULL</span><span class="s5">;</span>
    <span class="s1">fptr </span><span class="s5">= </span><span class="s1">fopen</span><span class="s5">(</span><span class="s2">&quot;C:</span><span class="s4">\\</span><span class="s2">pliki</span><span class="s4">\\</span><span class="s2">plik.txt&quot;</span><span class="s5">, </span><span class="s2">&quot;a&quot;</span><span class="s5">);</span>
    ...
    <span class="s5">}</span>
    <span class="s4">for </span><span class="s5">(</span><span class="s4">int </span><span class="s1">i </span><span class="s5">= </span><span class="s3">0</span><span class="s5">; </span><span class="s1">i </span><span class="s5">&lt; </span><span class="s1">SIZE</span><span class="s5">; ++</span><span class="s1">i</span><span class="s5">) {</span>
        <span class="s1">fprintf</span><span class="s5">(</span><span class="s1">fptr</span><span class="s5">, </span><span class="s2">&quot;%d</span><span class="s4">\n</span><span class="s2">&quot;</span><span class="s5">, </span><span class="s1">array</span><span class="s5">[</span><span class="s1">i</span><span class="s5">]);</span>
    <span class="s5">}</span>
...
<span class="s4">int </span><span class="s1">restorearrayfromfile</span><span class="s5">(</span><span class="s4">int </span><span class="s1">array</span><span class="s5">[]) {</span>
    <span class="s1">FILE </span><span class="s5">*</span><span class="s1">fptr </span><span class="s5">= </span><span class="s1">NULL</span><span class="s5">;</span>
    <span class="s1">fptr </span><span class="s5">= </span><span class="s1">fopen</span><span class="s5">(</span><span class="s2">&quot;C:</span><span class="s4">\\</span><span class="s2">pliki</span><span class="s4">\\</span><span class="s2">plik.txt&quot;</span><span class="s5">, </span><span class="s2">&quot;r&quot;</span><span class="s5">);</span>
    <span class="s4">if </span><span class="s5">(</span><span class="s1">fptr </span><span class="s5">== </span><span class="s1">NULL</span><span class="s5">) {</span>
        <span class="s4">return </span><span class="s3">1</span><span class="s5">;</span>
    <span class="s5">}</span>
    <span class="s4">int </span><span class="s1">i </span><span class="s5">= </span><span class="s3">0</span><span class="s5">;</span>
    <span class="s4">while </span><span class="s5">(</span><span class="s1">i </span><span class="s5">&lt; </span><span class="s1">SIZE </span><span class="s5">&amp;&amp; </span><span class="s1">fscanf</span><span class="s5">(</span><span class="s1">fptr</span><span class="s5">, </span><span class="s2">&quot;%d&quot;</span><span class="s5">, &amp;</span><span class="s1">array</span><span class="s5">[</span><span class="s1">i</span><span class="s5">]) == </span><span class="s3">1</span><span class="s5">) {</span>
    ...
    <span class="s4">do </span><span class="s5">{</span>
        ...
        <span class="s4">switch </span><span class="s5">(</span><span class="s1">option</span><span class="s5">) {</span>
            ...
            <span class="s4">case </span><span class="s3">5</span><span class="s1">:</span>
                <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;Zapisuje dane do pliku</span><span class="s4">\n\n</span><span class="s2">&quot;</span><span class="s5">);</span>
                <span class="s1">errorcode </span><span class="s5">= </span><span class="s1">savearraytofile</span><span class="s5">(</span><span class="s1">array</span><span class="s5">);</span>
                <span class="s4">if </span><span class="s5">(!</span><span class="s1">errorcode</span><span class="s5">) {</span>
                    <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;Tablica zapisana</span><span class="s4">\n\n</span><span class="s2">&quot;</span><span class="s5">);</span>
                <span class="s5">} </span><span class="s4">else </span><span class="s5">{</span>
                    <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;Tablica nie zapisana</span><span class="s4">\n\n</span><span class="s2">&quot;</span><span class="s5">);</span>
                <span class="s5">}</span>
                <span class="s4">break</span><span class="s5">;</span>
            <span class="s4">case </span><span class="s3">6</span><span class="s1">:</span>
                <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;Wczytuje dane z pliku</span><span class="s4">\n\n</span><span class="s2">&quot;</span><span class="s5">);</span>
                <span class="s1">errorcode </span><span class="s5">= </span><span class="s1">restorearrayfromfile</span><span class="s5">(</span><span class="s1">array</span><span class="s5">);</span>
                <span class="s4">if </span><span class="s5">(!</span><span class="s1">errorcode</span><span class="s5">) {</span>
                    <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;Tablica wczytana</span><span class="s4">\n\n</span><span class="s2">&quot;</span><span class="s5">);</span>
                <span class="s5">} </span><span class="s4">else </span><span class="s5">{</span>
                    <span class="s1">printf</span><span class="s5">(</span><span class="s2">&quot;Tablica nie wczytana</span><span class="s4">\n\n</span><span class="s2">&quot;</span><span class="s5">);</span>
                <span class="s5">}</span>
                <span class="s4">break</span><span class="s5">;</span>
